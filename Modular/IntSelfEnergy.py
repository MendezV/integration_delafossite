...
def main() -> int:
    ...
    Npoints=1000
    Npoints_int_pre, NpointsFS_pre=1000,1000
    save=True
    ...
    shifts=shifts*J
    delsd=delsd*J
    SE.output_res_fixed_w( [shifts, angles, delsd], J, T, False, "fixing_bug_smallerBZ_diff_peak_circular_FS_0.1_filling_1000_samples" )
