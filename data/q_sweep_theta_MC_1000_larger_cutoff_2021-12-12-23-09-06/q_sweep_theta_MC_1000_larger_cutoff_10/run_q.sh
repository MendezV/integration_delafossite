...
jobname="q_sweep_theta_MC_1000_larger_cutoff"  #JOBNAME importan to declare -has to be descriptive
...
for param_val in ${param_arr[@]}; do
	...
	nohup time python3 -u MomentumScan.py 1 1 ${param_val} CH1 >> output.out  
	cd "../../../Modular"
	sleep 1
