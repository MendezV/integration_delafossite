...
jobname="temperature_dep_no_shift_at_zero_frequency_freqdeo_integrandplot_threshodliszero"  #JOBNAME importan to declare -has to be descriptive
...
for T_val in ${T_arr[@]}; do
    ...
    cp no_shift_at_zero_frequency_fermi_surface_points_freqdep_thresholdiszero.py "${dire}"
	...
	time python3 -u no_shift_at_zero_frequency_fermi_surface_points_freqdep_thresholdiszero.py ${T_val} 1000 >> output.out & 
	cd "../../../MD_int"
	sleep 1
