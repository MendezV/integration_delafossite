...
print("shape of the angles array",np.shape( dsf2(xFS_dense+xFS_dense[0],yFS_dense+yFS_dense[0],Disp(xFS_dense+xFS_dense[0],yFS_dense+yFS_dense[0], mu) ) ))
...
Dispkq=Disp(xFS_dense+xFS_dense[inde],yFS_dense+yFS_dense[inde], mu) 
KQx=xFS_dense-xFS_dense[inde]
KQy=yFS_dense-yFS_dense[inde]
# plt.scatter(angles*180/np.pi,dsf2(KQx,KQy,Dispkq)*(1-1/(np.exp(Dispkq/T)+1)), s=3)
plt.scatter(angles*180/np.pi,dsf2(KQx,KQy,Dispkq), s=3)
plt.savefig(str(inde)+"plotintegrand_T_"+str(T)+"_mu_"+str((J*mu).round(decimals=2))+"_func_"+str(inde)+"dsf.png", dpi=200)
plt.close()
...
plt.plot([0],[0],'o')
plt.scatter(xFS_dense,yFS_dense, s=3)
plt.scatter(xFS_dense[inde],yFS_dense[inde], s=3)
plt.scatter(KQx,KQy, s=3, c=dsf2(KQx,KQy,Dispkq))
plt.savefig(str(inde)+"oneintegrand_T_"+str(T)+"_mu_"+str((J*mu).round(decimals=2))+"_func_"+str(inde)+"dsf.png", dpi=200)
plt.close()
...
plt.scatter(xFS_dense[inde],yFS_dense[inde], s=3)
plt.scatter(KQx,KQy, s=3, c=dsf2(KQx,KQy,Dispkq))
plt.scatter(KQx-b_1[0],KQy-b_1[1], c=dsf2(KQx,KQy,Dispkq), s=3)
plt.scatter(KQx-b_2[0],KQy-b_2[1], c=dsf2(KQx,KQy,Dispkq), s=3)
plt.scatter(KQx+b_1[0],KQy+b_1[1], c=dsf2(KQx,KQy,Dispkq), s=3)
plt.scatter(KQx+b_2[0],KQy+b_2[1], c=dsf2(KQx,KQy,Dispkq), s=3)
plt.scatter(KQx-b_2[0]-b_1[0],KQy-b_2[1]-b_1[1], c=dsf2(KQx,KQy,Dispkq), s=3)
plt.scatter(KQx+b_2[0]+b_1[0],KQy+b_2[1]+b_1[1], c=dsf2(KQx,KQy,Dispkq), s=3)
plt.savefig(str(inde)+"integrand_T_"+str(T)+"_mu_"+str((J*mu).round(decimals=2))+"_func_"+str(inde)+"dsf.png", dpi=200)
plt.close()